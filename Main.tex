...
% der Kolumnentitel ist in der .sty Datei hinterlegt.
...
\usepackage{upgreek}  % Für aufrechte griechische Buchstaben
...
% test wegen Quellen - empfohlen von Chat-GPT.
...
%\input{Anhang.tex}
\clearpage
%\input{Ehrenwörtliche Erklärung.tex}   not needed, cause Dokument beigelegt.
\end{document}
