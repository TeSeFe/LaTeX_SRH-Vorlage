...
% griechischer Buchstabe = phi (V-Wert = phi nur mit minus)
% Gewaltart x²(1) = 485,52, p < .001, V = .75, Täter*innen-Geschlecht x²(1) = 748,16, p < .001, φ = .93, Sozio-ökonomischer Status x²(1) = 422,37, p < .001, φ = .70 und kultureller Status x²(1) = 789,68, p < .001, V = .96
...
Die physische Aggression korrelierte mittelgradig mit den weiteren Subskalen verbaler Aggression ($r$~=~.36, $p<$~.001), Ärger ($r$~=~.46, $p<$~.001) und Misstrauen ($r$~=~.31, $p<$~.001).
