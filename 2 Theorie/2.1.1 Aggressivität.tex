...
nich immer offen ausgeführt und ist unterschiedlich ausgeprägt. %Punkt nachher entfernen
...
\end{itemize}
%\indent \parencite{Def_Aggressivität_eng1}

%Aggression
Aggression hingegen ist als vorübergehende Handlungsart zu verstehen, die es zum Ziel hat eine 
Person oder einen Gegenstand zu verletzen oder zu schädigen. %Punkt nachher entfernen 
%\parencite{Def_Aggression_1939; Def_unterscheidung_Springer, 
% Def_Aggression_Duden}.
...
von Beziehungen fördert, dann bezeichnet Ellis %\textcite{positive_aggression} 
es als positives und gesundes Verhalten. Wie Liu %\textcite{Aggression} 
...
%Punkt nachher entfernen     \parencite{Aggression}.
Positive Aggression hat viele Formen und Facetten. Ergänzend zu Ellis %\textcite{positive_aggression}
zählt Jack %\textcite{jack1999behind}
...
Begriffe ist dennoch nicht einfach. Clark %\textcite{Def_Aggressivität_vs_violence}
...
%\parencite{impulsive_instrumental_aggro_healtline; physische_verbale_aggro; physische_verbale_aggro_2}.
